  ...
  <div>
    <el-row style="">
      ...
      <el-col :span="12" style="margin-top:2.1%">
        ...
        <el-row type="flex" style="text-align:left;margin-top:30px;margin-left:30px">
          <el-col :span="12" class="showPriceName">
            Contract Deadline
          </el-col>
          <el-col :span="12" class="showPrice">
        ...
        <el-row type="flex" style="text-align:center;margin-top:30px;margin-left:30px">
          <div class="outddl">
        ...
        <el-row style="margin-top:30px;margin-left:30px">
          <el-button class="repayBtn" size="medium" @click="dialogVisible = true">
            <div class="repay_font">GET NFT</div>
          </el-button>
        </el-row>
    ...
    >
      ...
      <el-row style="margin-top:5%">
        <el-col :span="15" style="text-align:left;margin-left:2%" class="dialog_font">
          <el-image
              style=""
        ...
        <el-col :span="7" style="text-align:right;margin-right:2%" class="dialog_font">
          {{ nft_info.creator }}<br>
          {{ nft_info.name }}
        </el-col>
      ...
      <el-row style="margin-top:5%">
        <el-col :span="11" style="text-align:left;margin-left:2%" class="dialog_font">Loan Price</el-col>
      ...
      <span slot="footer" class="dialog-footer" style="vertical-align:middle">
            <el-row style="text-align:center;vertical-align:middle">
                <el-col :span="12" style="text-align:center">
                    <button class="checkoutBtn" @click="getNFT" style="margin-left:30%"><div class="checkoutFont">Confirm</div></button>
                </el-col>
                <el-col :span="12" style="text-align:center">
    ...
    <span slot="footer" class="dialog-footer">
        ...
        <router-link to="/mine"><el-button type="primary" @click="getNFT">Confirm</el-button></router-link>
    </span>
    </el-dialog>
    </el-row> -->
  ...
  methods: {
    ...
    getNFT() {
      ...
      async function main() {
        ...
        let transaction = await contract.retrieveNFT(itemId)
        ...
        _this.$message.success("Successfully get NFT !");
        _this.$router.push({path: '/mine', query: {name: '1'}});
      }

      main().catch(e => {
        console.error(e);
        this.$message.error("Fail to get NFT!");
      });
    ...
    async getNFTInfo(itemUrl) {
      ...
      async function main() {
        ...
        _this.nft_info.owner = itemInfo[5].toString();
